...
export default function Boeing() {
  return (<div className='m-2'>
    ...
    <div className="main_panel text-white rounded-[5px] w-full h-[350px] bg-center bg-cover bg-[linear-gradient(to_right,rgba(0,57,166,0.6),rgba(0,57,166,0)),url('https://www.boeing.com/content/theboeingcompany/us/en/features/2024/03/15-years-of-777-freighter-success/jcr%3acontent/cq%3afeaturedimage.img.jpg/1710177882294.jpg')]">
